...
Version  : 6.1.0
Release  : 133
URL      : https://download.kde.org/stable/plasma/6.1.0/plasma-workspace-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.0/plasma-workspace-6.1.0.tar.xz
Source1  : kde.pam
Source2  : kde-np.pam
...
- Setting night time color temperature (Night Light)
...
%prep
%setup -q -n plasma-workspace-6.1.0
cd %{_builddir}/plasma-workspace-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718903893
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libbatterycontrol.so.6.1.0
/V3/usr/lib64/libcolorcorrect.so.6.1.0
/V3/usr/lib64/libkfontinst.so.6.1.0
/V3/usr/lib64/libkfontinstui.so.6.1.0
/V3/usr/lib64/libkmpris.so.6.1.0
/V3/usr/lib64/libkworkspace6.so.6.1.0
/V3/usr/lib64/libnotificationmanager.so.6.1.0
/V3/usr/lib64/libplasma-geolocation-interface.so.6.1.0
/V3/usr/lib64/libtaskmanager.so.6.1.0
...
/usr/lib64/libbatterycontrol.so.6.1.0
/usr/lib64/libcolorcorrect.so.6
/usr/lib64/libcolorcorrect.so.6.1.0
/usr/lib64/libkfontinst.so.6
/usr/lib64/libkfontinst.so.6.1.0
/usr/lib64/libkfontinstui.so.6
/usr/lib64/libkfontinstui.so.6.1.0
/usr/lib64/libkmpris.so.6
/usr/lib64/libkmpris.so.6.1.0
/usr/lib64/libkworkspace6.so.6
/usr/lib64/libkworkspace6.so.6.1.0
/usr/lib64/libnotificationmanager.so.1
/usr/lib64/libnotificationmanager.so.6.1.0
/usr/lib64/libplasma-geolocation-interface.so.6
/usr/lib64/libplasma-geolocation-interface.so.6.1.0
/usr/lib64/libtaskmanager.so.6
/usr/lib64/libtaskmanager.so.6.1.0
