...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698286838
mkdir -p clr-build
pushd clr-build
...
%files
%defattr(-,root,root,-)
/V3/builddir/build/BUILD/plasma-workspace-5.27.9.1/clr-build-avx2/waylandtasksmodeltest
...
/builddir/build/BUILD/plasma-workspace-5.27.9.1/clr-build/waylandtasksmodeltest
