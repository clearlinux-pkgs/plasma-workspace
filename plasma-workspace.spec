...
Source0  : https://download.kde.org/stable/plasma/6.2.5/plasma-workspace-6.2.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.5/plasma-workspace-6.2.5.tar.xz.sig
...
%setup -q -n plasma-workspace-6.2.5
cd %{_builddir}/plasma-workspace-6.2.5
pushd ..
cp -a plasma-workspace-6.2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736198211
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libbatterycontrol.so.6.2.5
/V3/usr/lib64/libcolorcorrect.so.6.2.5
/V3/usr/lib64/libkfontinst.so.6.2.5
/V3/usr/lib64/libkfontinstui.so.6.2.5
/V3/usr/lib64/libklipper.so.6.2.5
/V3/usr/lib64/libkmpris.so.6.2.5
/V3/usr/lib64/libkworkspace6.so.6.2.5
/V3/usr/lib64/libnotificationmanager.so.6.2.5
/V3/usr/lib64/libplasma-geolocation-interface.so.6.2.5
/V3/usr/lib64/libtaskmanager.so.6.2.5
...
/usr/lib64/libbatterycontrol.so.6.2.5
/usr/lib64/libcolorcorrect.so.6
/usr/lib64/libcolorcorrect.so.6.2.5
/usr/lib64/libkfontinst.so.6
/usr/lib64/libkfontinst.so.6.2.5
/usr/lib64/libkfontinstui.so.6
/usr/lib64/libkfontinstui.so.6.2.5
/usr/lib64/libklipper.so.6
/usr/lib64/libklipper.so.6.2.5
/usr/lib64/libkmpris.so.6
/usr/lib64/libkmpris.so.6.2.5
/usr/lib64/libkworkspace6.so.6
/usr/lib64/libkworkspace6.so.6.2.5
/usr/lib64/libnotificationmanager.so.1
/usr/lib64/libnotificationmanager.so.6.2.5
/usr/lib64/libplasma-geolocation-interface.so.6
/usr/lib64/libplasma-geolocation-interface.so.6.2.5
/usr/lib64/libtaskmanager.so.6
/usr/lib64/libtaskmanager.so.6.2.5
