...
Version  : 6.0.2
Release  : 127
URL      : https://download.kde.org/stable/plasma/6.0.2/plasma-workspace-6.0.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.2/plasma-workspace-6.0.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.2/plasma-workspace-6.0.2.tar.xz.sig
Source2  : kde.pam
Source3  : kde-np.pam
...
%prep
%setup -q -n plasma-workspace-6.0.2
cd %{_builddir}/plasma-workspace-6.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711135678
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libcolorcorrect.so.6.0.2
/V3/usr/lib64/libkfontinst.so.6.0.2
/V3/usr/lib64/libkfontinstui.so.6.0.2
/V3/usr/lib64/libkmpris.so.6.0.2
/V3/usr/lib64/libkworkspace6.so.6.0.2
/V3/usr/lib64/libnotificationmanager.so.6.0.2
/V3/usr/lib64/libplasma-geolocation-interface.so.6.0.2
/V3/usr/lib64/libtaskmanager.so.6.0.2
...
/usr/lib64/libcolorcorrect.so.6.0.2
/usr/lib64/libkfontinst.so.6
/usr/lib64/libkfontinst.so.6.0.2
/usr/lib64/libkfontinstui.so.6
/usr/lib64/libkfontinstui.so.6.0.2
/usr/lib64/libkmpris.so.6
/usr/lib64/libkmpris.so.6.0.2
/usr/lib64/libkworkspace6.so.6
/usr/lib64/libkworkspace6.so.6.0.2
/usr/lib64/libnotificationmanager.so.1
/usr/lib64/libnotificationmanager.so.6.0.2
/usr/lib64/libplasma-geolocation-interface.so.6
/usr/lib64/libplasma-geolocation-interface.so.6.0.2
/usr/lib64/libtaskmanager.so.6
/usr/lib64/libtaskmanager.so.6.0.2
